...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onBack }) => {
    // React 19: useActionState replaces useState for forms.
    // It manages the form's state (error), the submit action, and the pending status automatically.
        ...
        <PageAnimate className="min-h-screen w-full flex items-center justify-center bg-gray-900 relative overflow-hidden font-sans">
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                ...
                >
                    ...
                    {/* React 19: native action prop seamlessly connects the form to the useActionState handler. */}
