...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onBack }) => {
    // 💡 React 19: useActionState replaces controlled components for forms
    // It natively manages loading (isPending) and form state/errors without manual useState hooks
    const [state, formAction, isPending] = useActionState(
        async (_prevState: { error: string } | null, formData: FormData) => {
            ...
            // Simulate API authentication delay natively with Promises
