...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onBack }) => {
    // 🛰️ Spark Learning: useActionState replaces manual useState and onChange handlers for forms.
    // It natively handles loading states (isPending) and the returned error string, keeping components cleaner.
